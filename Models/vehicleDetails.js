...
const vehicleSchema = new mongoose.Schema(
  {
    ...
    basicInfo: {
      customizedType: { type: String, default: "Non-Customized" },
      // Backward-compatible cached label. Do not use this as the primary key.
      vehicleName: { type: String, default: "", trim: true },

      // Keep String storage to avoid a risky migration of existing records,
      // but enforce that the value is a valid VehicleType ObjectId string.
      vehicleType: {
        type: String,
        required: true,
        trim: true,
        validate: {
          ...
          message: "basicInfo.vehicleType must be a valid VehicleType ID",
        },
      },
    },
