...
// // ── NEW: Sales pipeline sub-schemas ─────────────────────────────────────────
...
//     // ── Sales pipeline (NEW — embedded in same Order doc) ────────
//     salesPipeline: {
//       // current stage
//       status: {
//         type: String,
...
//       // handler — reuses order.handlerName if already set,
//       // but sales can have its own handler too
//       salesHandlerName: { type: String, default: "" },

//       // negotiation final amount (grandTotal - sum of negotiation amounts)
//       salesNegotiationFinalAmount: { type: Number, default: null },

//       // per-stage document arrays
...
//       logs: { type: [salesPipelineLogSchema], default: [] },
//     },
//   },
//   { timestamps: true }
// );
